...
Route::get('/three/line', function(){
    return view('Three.line');
});

Route::get('/three/obj', function(){
    return view('Three.objLoad');
});

Route::get('/three/gltf', function(){
    return view('Three.gltf');
});

Route::get('/three/mmd', function(){
    return view('Three.mmd');
});
