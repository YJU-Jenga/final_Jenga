...
class QAController extends Controller
{
    ...
    public function viewQA(Request $request, $id)
    {
        ...
        $posts = DB::table('posts')->select(['posts.id', 'posts.user_id','posts.board_id', 'posts.title', 'posts.content', 'users.name', 'posts.hit', 'posts.created_at', 'posts.state', 'posts.img'])
            ->leftJoin('users', 'posts.user_id', '=', 'users.id')
            ->where('posts.id', $id)
            ->get();
