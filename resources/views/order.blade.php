            ...
            <div class="p-8 overflow-hidden bg-white shadow-sm sm:rounded-lg">
                ...
                <form class="mt-10" method="POST" action="{{ route('order_success') }}">
                    ...
                    <div class="mt-4 ">
                        ...
                        <div class ="flex items-center">
                            <input type="text" id="roadAddress" class = 'border-gray-300 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50' 
                            ...
                            <input type="text" id="extraAddress"class = 'border-gray-300 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50'
