                                ...
                                <tr class="h-full border-b">
                                    ...
                                    <td class="py-2">
                                        <a href='product-detail/{{ $item->id }}'>
                                            <img src="/storage/images/{{ $item->attributes->image }}" class="hidden object-contain w-20 rounded md:table-cell" alt="Thumbnail">
                                        </a>
                                    </td>
                                    {{-- product_name--}}
                                    <td>
                                    ...
                                    <td class="">
                                        <form action="{{ route('cart.update') }}" method="POST">
                                            ...
                                            <div class="flex items-center justify-center ">
                                                ...
                                                <input type="text" name="quantity" value="{{ $item->quantity }}" class="w-1/6 h-6 text-center text-gray-800 border border-gray-200 rounded-lg outline-none" />
                                                <button class="px-2 py-1 ml-1 text-sm text-center text-green-700 bg-white rounded-full shadow focus:outline-none focus:ring-gray-200">✓</button>
                                    ...
                                    <td class="text-center md:table-cell">
                                        <form action="{{ route('cart.remove') }}" method="POST">
                                            ...
                                            <button class="px-3 py-1.5 text-white bg-red-500 hover:bg-red-600 rounded-full shadow">X</button>
                                        </form>
